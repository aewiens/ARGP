...
surface1 = np.loadtxt("ccsd-t-tz.dat", delimiter=',', skiprows=1)
surface2 = np.loadtxt("ccsd-t-5z.dat", delimiter=',', skiprows=1)
...
for n in N2:
    ...
    g.close()
    f.write("{:>3d}{:>10.5f}".format(n, avg_rmse))
